          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="font-medium">{order.customer_info.phone_number || "N/A"}</div>
              </div>
            </div>
          </div>
            <div className="p-6 border-b border-gray-200">
        ...
        {order.livreur && (
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-gray-600">Name:</div>
                <div className="font-medium">{order.livreur.first_name } {order.livreur.last_name }</div>

                <div className="text-gray-600">Phone:</div>
                <div className="font-medium">
                  {order.livreur.user.phone_number || "N/A"}
                </div>
                <div className="text-gray-600">Email:</div>
                <div className="font-medium">
                  {order.livreur.user.email || "N/A"}
                </div>
              </div>
            </div>
          </div>
