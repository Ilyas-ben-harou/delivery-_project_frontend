                ...
                {distributors.length > 0 ? (
                  distributors.map((distributor) => (
                    <tr key={distributor.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{distributor.name}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{distributor.order_count}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">${distributor.total_earnings.toFixed(2)}</td>
